...
const GestionProyectos = () => {
    ...
    // Estado para el rol del usuario (simulado)
    const [usuarioRol, setUsuarioRol] = useState('administrador'); // Suponiendo que el rol del usuario es administrador
    ...
    // Define qué roles pueden editar y eliminar proyectos
    const puedeEditarEliminar = usuarioRol === 'administrador';

    return (
        <div className={styles.page}>
            <div className={styles.container}>
                <h2 className={styles.title}>Lista de Proyectos</h2>
                {/* Solo mostrar el botón de agregar si el usuario tiene el rol adecuado */}
                {puedeEditarEliminar && (
                        ...
                        {proyectos.map((proyecto) => (
                            <tr key={proyecto.id}>
                                ...
                                <td className={styles.buttonContainer}>
                                    {/* Solo mostrar los botones de editar y eliminar si el usuario tiene el rol adecuado */}
                                    {puedeEditarEliminar && (
                                        <>
